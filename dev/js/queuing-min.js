...
//          this.switch_id = 0;
    ...
    loadtext: function(a){
		...
		/* parse names */
		a = a.replace(/(?!["']username["']:)["'](queue|stack|source|sink|splitfunc|func|reverser|cloner|thermometer)_(\d+)["']/g, "\"preset_$1_$2\"")
        ...
        /* change potential duplicate names */
...
//                  break;
			...
			g.name = f.hasOwnProperty("name") ? f.name: g.name
